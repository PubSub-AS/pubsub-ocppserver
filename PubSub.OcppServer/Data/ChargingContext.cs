...
namespace PubSub.OcppServer.Data
{
    public class ChargingContext : DbContext
    {
        ...
        public DbSet<ChargingSchedulePeriod> ChargingSchedulePeriods { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ChargingTransaction>()
                .ToTable("ChargingTransactions");
            modelBuilder.Entity<ChargingPointProvider>().ToTable("ChargingPointProviders");
            modelBuilder.Entity<ChargingSchedulePeriod>().ToTable("ChargingSchedulePeriods");
            modelBuilder.Entity<Connector>().ToTable("Connectors");
            modelBuilder.Entity<Evse>().ToTable("Evses");
